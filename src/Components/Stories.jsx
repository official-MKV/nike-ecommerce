        ...
        <Splide options={splideOptions}>
          {news.map((val, i) => (
            <SplideSlide key={i} className="mb-0.5">
              <div className="realtive grid items-center gap-4 pb-2 rounded-lg shadow-slate-200 ring-1 ring-slate-100">
                <div className=" flex items-center justify-center">
                  <img
                    src={val.img}
                    alt={`img/story/${i}`}
                    className="w-full h-auto object-cover shadow-slate-200 rounded-tl-lg rounded-tr-lg "
                  />
                </div>
                ...
                <div className="grid items-center justify-center justify-items-start px-4">
                ...
                <div className="flex items-center px-4 justify-center w-full">
                  <a
                    ...
                    from-slate-900 to-black shadow-md
                     shadow-black text-center
                     text-slate-100
                     py-1.5
                     button-theme
                     "
